...
{
    /// <summary>
    /// Represents an array of strings which are keywords used for auto-completion
    /// </summary>
    public class Keywords
    {
        /// <summary>
        /// An array of strings which are used for auto-completion
        /// </summary>
        [XmlArray(ElementName = "Keyword")]
